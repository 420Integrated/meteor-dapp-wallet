...
@method (isHaze)
**/
Template.registerHelper('isHaze', function() {
  return window.hazeMode === undefined && window.haze !== undefined;
});

/**
Check if in haze and in haze mode

@method (isWalletMode)
**/
Template.registerHelper('isWalletMode', function() {
  // also show network info in normal browsers
  return window.hazeMode === 'wallet' || window.haze === undefined;
});

/**
Check if wallet was loaded from browser other than Haze

@method (isBrowserMode)
**/
Template.registerHelper('isBrowserMode', function() {
  return window.haze === undefined;
});

/**
Check if currency unit is a 420coin unit

@method (isFourtwentycoinUnit)
**/
Template.registerHelper('isFourtwentycoinUnit', function() {
...
Template.registerHelper('unit', function() {
  return FourtwentyTools.getUnit();
});
...
Template.registerHelper('latestBlock', function() {
  return FourtwentyBlocks.latest;
});
...
Formats a given transactions balance
    ...
    {{formatTransactionBalance value exchangeRates "420coin"}}
