...
Template['views_account_create'].helpers({
  ...
  defaultDailyLimit: function() {
    ...
    return typeof dailyLimit != 'undefined'
      ? web3.utils.fromMarley(dailyLimit.toString(), '420coin')
      : 10;
  },
  /**
    Default Name
...
Template['views_account_create'].events({
  ...
  submit: function(e, template) {
    ...
    var deployFrom = template
      .find('select[name="dapp-select-account"]')
      .value.toLowerCase();
    ...
    if (type === 'simple') {
      Wallets.insert({
        ...
        balance: '0',
        creationBlock: FourtwentyBlocks.latest.number,
        code: code
      });
    ...
    if (type === 'multisig') {
      ...
      Wallets.insert({
        ...
        name:
          ...
          TAPi18n.__('wallet.accounts.defaultName'),
        balance: '0',
        dailyLimit: web3.utils.toMarley(
