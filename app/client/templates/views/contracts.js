...
var addCustomContract = function(e) {
  ...
  if (web3.utils.isAddress(address)) {
    ...
    // update balances from lib/fourtwenty/observeBlocks.js
    updateBalances();
...
var autoScanGetTokens = function(template) {
  return new Promise(function(resolve, reject) {
    ...
    var tokenListURL =
      'https://raw.githubusercontent.com/MyFourtwentyWallet/420coin-lists/master/dist/tokens/420/tokens-fourtwenty.json';

    const accounts = _.pluck(
      FourtwentyAccounts.find()
        .fetch()
            ...
            try {
              const promise = web3.fourtwenty
                ...
                .then(function(result) {
                  ...
                  const tokenAmtInFourtwentycoin = web3.utils.fromMarley(tokenAmt, '420coin');
              ...
              const errorString = 'Error trying to web3.fourtwenty.call: ' + error;
              console.error(errorString);
              TemplateVar.set(template, 'autoScanStatus', errorString);
            }
          });
