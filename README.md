...
[![Build Status](https://travis-ci.org/fourtwenty/meteor-dapp-wallet.svg?branch=master)](https://travis-ci.org/fourtwenty/meteor-dapp-wallet)
...
Start a `g420` node:
    ...
    $ g420 --ws --wsorigins "http://localhost:3000" --unlock <your account>
...
To deploy to the **wallet.420integrated.com** site, execute these commands:
